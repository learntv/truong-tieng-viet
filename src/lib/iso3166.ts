/**
 * ISO 3166-1 alpha-2 -> numeric-3 code, for matching `profiles.country` (alpha-2, e.g. "US")
 * against the "id" field of world-atlas TopoJSON geographies (UN M49 numeric codes).
 * Reference: https://www.iso.org/obp/ui/#search — not app data, just the published standard.
 */
export const ISO_ALPHA2_TO_NUMERIC: Record<string, string> = {
  ...
  ZM: "894", ZW: "716", HK: "344", MO: "446", PS: "275",
};
