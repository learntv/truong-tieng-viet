    ...
    <div className="flex h-full flex-col rounded-3xl border-4 border-white bg-card p-4 shadow-soft sm:p-5">
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          ...
          <button onClick={onToggleCollapsed} className="grid h-7 w-7 place-items-center rounded-full bg-muted text-navy shadow-card transition hover:scale-105" aria-label="Thu gọn tiến độ chương trình">
