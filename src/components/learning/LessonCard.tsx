  ...
  return (
    <div className="relative flex h-full w-full items-stretch justify-center">
      <button
        ...
        disabled={!canPrev}
        aria-label="Trước"
        className="absolute left-0 top-1/2 z-10 grid h-11 w-11 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full bg-white text-navy shadow-card ring-1 ring-border transition hover:scale-110 disabled:cursor-not-allowed disabled:opacity-30 sm:h-14 sm:w-14"
      >
      ...
      <div
        className={[
          "flex max-h-full w-full flex-col overflow-hidden rounded-3xl shadow-soft",
          color.bgSoft,
        ].join(" ")}
      >
        <div
          className={[
            "flex items-center justify-between gap-3 px-5 py-4 sm:px-7",
            color.gradient,
          ].join(" ")}
        >
        ...
        {isLastNoiDung && (
          <div className="flex items-center justify-center border-t border-border/60 px-4 py-4 sm:px-6 sm:py-5">
            <button
              onClick={onComplete}
      ...
      <button
        ...
        aria-label="Tiếp"
        className={[
          "absolute right-0 top-1/2 z-10 grid h-11 w-11 -translate-y-1/2 translate-x-1/2 place-items-center rounded-full text-white shadow-card transition hover:scale-110 disabled:cursor-not-allowed disabled:opacity-30 sm:h-14 sm:w-14",
          color.gradient,
        ].join(" ")}
      >
