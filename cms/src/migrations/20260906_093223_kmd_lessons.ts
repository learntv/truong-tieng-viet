...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TABLE "payload"."bai_kmd_blocks_worksheet" (
  ...
  ALTER TABLE "payload"."bai_kmd_blocks_worksheet" ADD CONSTRAINT "bai_kmd_blocks_worksheet_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "payload"."bai_kmd"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "bai_kmd_blocks_worksheet_order_idx" ON "payload"."bai_kmd_blocks_worksheet" USING btree ("_order");
  CREATE INDEX "bai_kmd_blocks_worksheet_parent_id_idx" ON "payload"."bai_kmd_blocks_worksheet" USING btree ("_parent_id");
  CREATE INDEX "bai_kmd_blocks_worksheet_path_idx" ON "payload"."bai_kmd_blocks_worksheet" USING btree ("_path");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "payload"."bai_kmd_blocks_worksheet" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "payload"."bai_kmd" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "payload"."bai_kmd_texts" DISABLE ROW LEVEL SECURITY;
  DROP TABLE "payload"."bai_kmd_blocks_worksheet" CASCADE;
